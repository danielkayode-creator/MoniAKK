...
export default function EnquiryDialog({ children, projectName }: { children: ReactNode; projectName?: string }) {
    return <Dialog><DialogTrigger asChild>{children}</DialogTrigger>
        <DialogContent className="max-h-dvh max-w-full overflow-auto bg-[#FDFEFE] text-[#171717] sm:max-w-full lg:max-h-[95%] lg:grid-cols-2 lg:gap-12 lg:px-20 lg:py-20">
            ...
            <div className="space-y-6"><h2 className="text-lg lg:text-3xl">Fill out the form and we&apos;ll be in touch.</h2><EnquiryForm projectName={projectName} /></div>
